 ...
 *
 * Only public and protected properties are read — the same rule
 * {@see \Zestry\WPToolkit\Kernel\Traits\WithPlugin::inject_modules()} uses, for the same
 * reason: reflection cannot reliably reach a private property declared on an
 * ancestor. A private one marked with this attribute is left alone entirely,
 * appearing in no schema and never bound.
 */
