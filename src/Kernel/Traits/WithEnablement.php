 ...
 * Checked once, when the file is discovered, so a false costs nothing afterwards
 * -- nothing is registered, no hook is bound, and WordPress never hears of it.
 *
 * ```
...
trait WithEnablement {
	 ...
	 *
	 * Called once, at discovery, after the instance is wired and before anything
	 * is registered. Return false and nothing happens: no hook is bound, no
	 * WordPress registration is made, and the file might as well not be there.
	 *
